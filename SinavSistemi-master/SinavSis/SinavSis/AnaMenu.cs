...
namespace SinavSis
{
    ...
    {
        SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-C9KDPNN;Initial Catalog='Yazılım test proje';Integrated Security=True");// @"Data Source=DESKTOP-C9KDPNN;Initial Catalog='Yazılım test proje';Integrated Security=True",
        ...
        private void simpleButton5_Click(object sender, EventArgs e)
        {
            ...
            using (SqlCommand StrQuer = new SqlCommand("SELECT * FROM ogretmen WHERE ogretmenKullanıcıAdi=@userid AND Sifre=@password", baglanti))
            {
